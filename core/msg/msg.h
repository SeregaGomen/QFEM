...
#define S_MSG_CREATE_LOAD_DYNAMIC           ((langCode) ? "Формирование динамического вектора-столбца нагрузки" : "Building the dynamic load vector-column")
...
#define S_MSG_CREATE_STATIC_MATRIX_PROCESS  ((langCode) ? "Формирование глобальной матрицы жесткости" : "Building a global stiffness matrix")
#define S_MSG_CREATE_GLOBAL_MATRIX_PROCESS  ((langCode) ? "Формирование глобальных матриц" : "Building of the global matrix")
#define S_MSG_CREATE_DYNAMIC_MATRIX_PROCESS ((langCode) ? "Формирование динамической матрицы" : "Building of the dynamic matrix")
...
inline string sayProcess(ProcessCode code)
{
    switch (code)
    {
        case ProcessCode::GeneratingStaticMatrix:
            return S_MSG_CREATE_STATIC_MATRIX_PROCESS;
        case ProcessCode::GeneratingGlobalMatrix:
            return S_MSG_CREATE_GLOBAL_MATRIX_PROCESS;
        case ProcessCode::GeneratingDynamicMatrix:
            return S_MSG_CREATE_DYNAMIC_MATRIX_PROCESS;
        ...
        case ProcessCode::GeneratingDynamicLoad:
            return S_MSG_CREATE_LOAD_DYNAMIC;
